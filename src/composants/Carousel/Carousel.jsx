    ...
    return (
        <div className='view-box'>
            <div className={`carousel ${resize}`} style={transform}>
                ...
                <div ><Project  desc="Developpement frontend, en utlisant React+vite d'un site de location." pb="Pour ce projet j'ai suivi le cours sur React de Open Classerooms ce qui m'a permis d'apprendre le code modulaire et l'initialisation d'une app React+vite." pres={kasaPres}logo={Kasa} skillOne={booki} skillTwo={ReactL} skillThree={js} link="https://github.com/Martin-gldr/Projet-5OC.git"/></div>
