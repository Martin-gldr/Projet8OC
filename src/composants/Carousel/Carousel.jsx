    ...
    return (
        <div className='view-box'>
            <div className={`carousel ${resize}`} style={transform}>
                <div ref={ref}><Project  desc="Integration css et html d'un site de renseignements touristique." pb="Pour ce projet j'ai du réussir à bien optimiser mon CSS pour que le rendu soit responsive au maximum, j'ai nottement réussit cela en me formant sur le cours HTML/CSS de Openclassrooms." logo={booki} skillOne={html} skillTwo={css} skillThreeClass='hide' link="https://github.com/Martin-gldr/projet2OC.git"/></div>
                <div ><Project  desc="Developpement frontend d'un site d'architect d'interieur." pb="Pour ce projet j'ai du apprendre a bien organiser mon code JS en fonctions pour qu'il soit clair et fonctionnel, de plus j'ai du bien comprendre comment créer des éléments depuis le javascript à partir d'un fichier de donné." logo={bluel} skillOne={html} skillTwo={css} skillThree={js} link="https://github.com/Martin-gldr/Projet3OC.git" /></div>
                <div ><Project  desc="Débuggage et optimisation SEO d'un site de photographie." pb="Pour ce projet j'ai du apprendre à me servir de l'outils de débuggage de Chrome, et comprendre le SEO à l'aide d'articles sépcialisés."logo={nina} skillOne={lighthouse} skillTwo={SEO} skillThree={debug} link="https://github.com/Martin-gldr/Projet-4OC.git"/></div>
                <div ><Project  desc="Developpement frontend, en utlisant React+vite d'un site de location." pb="Pour ce projet j'ai suivi le cours sur React de Open Classerooms ce qui m'a permis d'apprendre le code modulaire et l'initialisation d'une app React+vite."logo={Kasa} skillOne={booki} skillTwo={ReactL} skillThree={js} link="https://github.com/Martin-gldr/Projet-5OC.git"/></div>
                <div ><Project  desc="Developpement du backend d'un site de notation de livre." pb="Dans ce projet j'ai du comprendre les routes CRUD et leur developpement, j'ai réussi nottement à l'aide de Postman et d'une methodologie Essaie-erreur." logo={livre} skillOne={nodejs} skillTwo={express} skillThree={mongodb} link="https://github.com/Martin-gldr/projet6OC.git" /></div>
                <div ><Project  desc="Gestion du projet pour le developpement d'un site de creation et exportation de menus." pb="Pour ce projet j'ai du apprendre a maitriser Notion, et comprendre la méthodologie agile Srcum, des articles spécialisés m'ont permis de surmonter ces problématiques." logo={qwenta} skillOne={notion} skillTwo={feedly} skillThree={scrum}/></div>
